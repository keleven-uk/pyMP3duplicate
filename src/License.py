###############################################################################################################
#    myLicense.py   Copyright (C) <2020-2025>  <Kevin Scott>                                                       #
#                                                                                                             #
...
def printShortLicense(name, version, textFile, screen=False):
    ...
    duplicateUtils.logTextLine(f"{name} {version}   Copyright (C) 2020-2025  Kevin Scott", textFile)
    ...
    if screen:
        print("")
        print(f"{name} {version}   Copyright (C) 2020-2025  Kevin Scott")
...
def printLongLicense(name, version):
    print(f"""
    {name} {version}  Copyright (C) 2020-2025  Kevin Scott
